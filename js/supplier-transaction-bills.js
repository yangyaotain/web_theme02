(function () {
    ...
    var sharedBillData = window.TransactionBillDemoData;
    var CURRENT_SUPPLIER_NAME = sharedBillData ? sharedBillData.currentSupplierName : '深圳市龙岗数智科技有限公司';
    var RECEIVABLE_RECORDS = sharedBillData ? sharedBillData.getSupplierReceivables(CURRENT_SUPPLIER_NAME) : [];
    ...
    function initSupplierTransactionBills() {
        ...
        var toastTimer = null;
        var supplierName = CURRENT_SUPPLIER_NAME;
