...
(function (global) {
    ...
    var messages = [
        ...
        { id: 23, type: '告警消息', category: 'alert', status: 'unread', title: '供方【深圳市龙岗数据服务有限公司】近期交易纠纷率为：9.2%，大于8%，请运营人员关注订单【DD-20260630-0098】。', content: '供方【深圳市龙岗数据服务有限公司】近期交易纠纷率为：9.2%，大于8%，请运营人员关注订单【DD-20260630-0098】。', time: '2026-06-30 10:15:00' },
        { id: 24, type: '告警消息', category: 'alert', status: 'unread', title: '接口【企业画像查询接口】在2026-06-30 10:30触发告警，5分钟内接口调用失败次数为：12次，大于10次，请供方【深圳市龙岗数据服务有限公司】处理。', content: '接口【企业画像查询接口】在2026-06-30 10:30触发告警，5分钟内接口调用失败次数为：12次，大于10次，请供方【深圳市龙岗数据服务有限公司】处理。', time: '2026-06-30 10:10:00' },
        { id: 25, type: '告警消息', category: 'alert', status: 'unread', title: '接口【企业画像查询接口】连续调用失败，10分钟内接口连续调用失败为：4次，大于3次，订单【DD-20260630-0098】请尽快排查。', content: '接口【企业画像查询接口】连续调用失败，10分钟内接口连续调用失败为：4次，大于3次，订单【DD-20260630-0098】请尽快排查。', time: '2026-06-30 10:05:00' },
        { id: 26, type: '告警消息', category: 'alert', status: 'unread', title: '接口【企业画像查询接口】触发失败率告警，10分钟内接口调用失败率为：23%，大于20%，需方【龙岗智慧园区运营中心】可能受影响。', content: '接口【企业画像查询接口】触发失败率告警，10分钟内接口调用失败率为：23%，大于20%，需方【龙岗智慧园区运营中心】可能受影响。', time: '2026-06-30 10:00:00' },
        { id: 27, type: '告警消息', category: 'alert', status: 'unread', title: '接口【企业画像查询接口】响应时间异常，5分钟内接口响应时间为：3250ms，大于3000ms，告警时间：2026-06-30 10:30。', content: '接口【企业画像查询接口】响应时间异常，5分钟内接口响应时间为：3250ms，大于3000ms，告警时间：2026-06-30 10:30。', time: '2026-06-30 09:55:00' },
        { id: 28, type: '告警消息', category: 'alert', status: 'unread', title: '接口【企业画像查询接口】调用用量突增，1小时内接口调用用量为历史均值的3.6倍，大于3倍，订单【企业画像接口服务】请关注。', content: '接口【企业画像查询接口】调用用量突增，1小时内接口调用用量为历史均值的3.6倍，大于3倍，订单【企业画像接口服务】请关注。', time: '2026-06-30 09:50:00' },
        { id: 29, type: '告警消息', category: 'alert', status: 'unread', title: '订单【企业画像接口服务】的接口【企业画像查询接口】调用偏低，7天内接口调用次数为：0次，小于等于0次，请跟进需方【龙岗智慧园区运营中心】。', content: '订单【企业画像接口服务】的接口【企业画像查询接口】调用偏低，7天内接口调用次数为：0次，小于等于0次，请跟进需方【龙岗智慧园区运营中心】。', time: '2026-06-30 09:45:00' },
    ...
    function renderPage(target) {
        ...
        function drawerTitle(item) {
            if (item && item.category === 'alert') {
                return item.title || item.content || '';
            }
            return businessTitle(item ? item.title : '');
        }
        ...
        function openDrawer(id) {
            ...
            body.innerHTML = [
                ...
                '<div class="mc-drawer-title">' + escapeHtml(drawerTitle(item)) + '</div>',
