(function () {
    ...
    var CONTRACTS = [
        {
            id: 'LG-CP-20260717-119048', type: 'product', orderNo: '2026071717251106400000101149048', name: '龙岗区交通运行拥堵指数服务交易合同', itemName: '龙岗区交通运行拥堵指数服务', provider: '深圳市龙岗数智科技有限公司', demander: '龙岗智慧交通科技有限公司', amount: 1500, serviceFeeMode: 'G', serviceFeeValue: 50, signedAt: '2026-07-18', effectiveAt: '2026-07-18', endsAt: '2027-07-17', supplierStatus: '待供方签署', buyerStatus: '履约中', updatedAt: '2026-07-18 10:22:16', stages: [{ name: '一次性付款', percent: 100, amount: 1500, state: '待支付' }]
        },
        {
            id: 'LG-CP-20260716-114833', type: 'product', orderNo: '2026071610053204300000101148331', name: '产业链企业图谱查询交易合同', itemName: '产业链企业图谱查询产品', provider: '深圳市龙岗数智科技有限公司', demander: '深圳龙岗科创金融服务有限公司', amount: 1500, serviceFeeMode: 'G', serviceFeeValue: 50, signedAt: '2026-07-16', effectiveAt: '2026-07-16', endsAt: '2027-07-15', supplierStatus: '履约中', buyerStatus: '履约中', updatedAt: '2026-07-17 09:08:42', stages: [{ name: '一次性付款', percent: 100, amount: 1500, state: '已支付' }]
        },
        {
            id: 'LG-CP-20260610-118853', type: 'product', orderNo: '2026061014253600800000101148853', name: '中小微企业扶持政策匹配数据集交易合同', itemName: '龙岗区中小微企业扶持政策匹配数据集', provider: '龙岗区企业服务集团有限公司', demander: '深圳市龙岗智慧产业有限公司', amount: 250, serviceFeeMode: 'P', serviceFeeValue: 3, signedAt: '2026-06-11', effectiveAt: '2026-06-11', endsAt: '2027-06-10', supplierStatus: '履约中', buyerStatus: '待需方签署', updatedAt: '2026-06-11 09:36:12', stages: [{ name: '一次性付款', percent: 100, amount: 250, state: '待支付' }]
        },
        {
            id: 'LG-FW-20260718-114949', type: 'service', orderNo: '2026071817245104300000101149449', name: '数字化转型顶层规划咨询服务合同', itemName: '数字化转型顶层规划咨询服务', provider: '深圳市龙岗数智科技有限公司', demander: '龙岗数智产业研究院有限公司', amount: 8000, serviceFeeMode: 'P', serviceFeeValue: 2.5, signedAt: '2026-07-19', effectiveAt: '2026-07-19', endsAt: '2026-10-19', supplierStatus: '待供方签署', buyerStatus: '履约中', updatedAt: '2026-07-19 11:34:25', stages: [{ name: '首期款', percent: 30, amount: 2400, state: '待支付（首次）' }, { name: '阶段款', percent: 40, amount: 3200, state: '未到付款节点' }, { name: '尾款', percent: 30, amount: 2400, state: '未到付款节点' }]
        },
        {
            id: 'LG-FW-20260619-118466', type: 'service', orderNo: '2026061916051502100000101148466', name: '金融风控数据建模与实施服务合同', itemName: '福田区金融风控数据建模与实施服务', provider: '深圳市龙岗区数据服务中心', demander: '深圳市龙岗智慧产业有限公司', amount: 1000, serviceFeeMode: 'G', serviceFeeValue: 50, signedAt: '2026-06-20', effectiveAt: '2026-06-20', endsAt: '2026-09-20', supplierStatus: '履约中', buyerStatus: '待需方签署', updatedAt: '2026-06-20 10:15:36', stages: [{ name: '首期款', percent: 30, amount: 300, state: '待支付（首次）' }, { name: '阶段款', percent: 40, amount: 400, state: '未到付款节点' }, { name: '尾款', percent: 30, amount: 300, state: '未到付款节点' }]
        },
        {
            id: 'LG-FW-20260715-113908', type: 'service', orderNo: '2026071510364507600000101139088', name: '数据治理成熟度评估服务合同', itemName: '数据治理成熟度评估服务', provider: '深圳市龙岗数智科技有限公司', demander: '龙岗区数据应用创新中心', amount: 12000, serviceFeeMode: 'P', serviceFeeValue: 3, signedAt: '2026-07-15', effectiveAt: '2026-07-15', endsAt: '2026-11-15', supplierStatus: '履约中', buyerStatus: '履约中', updatedAt: '2026-07-21 15:16:20', stages: [{ name: '首期款', percent: 30, amount: 3600, state: '已支付' }, { name: '方案确认款', percent: 20, amount: 2400, state: '已支付' }, { name: '初验款', percent: 30, amount: 3600, state: '待支付（阶段）' }, { name: '尾款', percent: 20, amount: 2400, state: '未到付款节点' }]
        },
        {
            id: 'LG-FW-20260628-112760', type: 'service', orderNo: '2026062810241507600000101127602', name: '公共数据授权运营咨询服务合同', itemName: '公共数据授权运营咨询服务', provider: '深圳市龙岗数智科技有限公司', demander: '龙岗数智产业研究院有限公司', amount: 20000, serviceFeeMode: 'P', serviceFeeValue: 2.5, signedAt: '2026-06-29', effectiveAt: '2026-06-29', endsAt: '2026-09-30', supplierStatus: '履约中', buyerStatus: '履约中', updatedAt: '2026-07-22 08:42:10', stages: [{ name: '首期款', percent: 30, amount: 6000, state: '已支付' }, { name: '阶段款', percent: 40, amount: 8000, state: '已支付' }, { name: '尾款', percent: 30, amount: 6000, state: '待支付（最后）' }]
        }
    ];
    ...
    function getServiceFeeMode(item) {
        return item.serviceFeeMode === 'G' ? 'G' : 'P';
    }

    function getServiceFeeValue(item) {
        var value = Number(item.serviceFeeValue);
        return Number.isFinite(value) ? value : Number(item.serviceFeeRate || 0);
    }

    function calculateStageServiceFee(item, stageAmount) {
        var value = getServiceFeeValue(item);
        return getServiceFeeMode(item) === 'G' ? value : Number(stageAmount || 0) * value / 100;
    }

    function formatServiceFeeRule(item) {
        var value = getServiceFeeValue(item);
        return getServiceFeeMode(item) === 'G'
            ? '固定金额 ¥' + value.toFixed(2) + '/笔'
            : '金额比例 ' + value.toFixed(2) + '%';
    }
    ...
    function renderDrawer() {
        ...
        var totalServiceFee = selfOperated ? 0 : item.stages.reduce(function (sum, stage) {
            return sum + calculateStageServiceFee(item, stage.amount);
        }, 0);
        var stageRows = item.stages.map(function (stage, index) {
            var fee = calculateStageServiceFee(item, stage.amount);
        ...
        var stageFoot = selfOperated
            ...
            : '<tr><td colspan="2">合计</td><td>100.00%</td><td>¥' + item.amount.toFixed(2) + '</td><td>¥' + totalServiceFee.toFixed(2) + '</td><td>¥' + (item.amount - totalServiceFee).toFixed(2) + '</td><td></td><td></td></tr>';
        var signPanel = drawerMode === 'sign' ? '<section class="trade-contract-sign-panel"><label><input type="checkbox" data-contract-agree><span>我已核对合同主体、金额、付款计划' + (selfOperated ? '' : '及平台服务费条款') + '，同意签署本合同。</span></label><p>签署后付款计划' + (selfOperated ? '' : '和服务费计费规则') + '将冻结，后续调整不追溯本合同。</p></section>' : '';
        return ''
            ...
            +       '<section><div class="trade-contract-section-head"><h3>' + (selfOperated ? '付款条款' : '付款与分账条款') + '</h3><span class="trade-contract-frozen">' + icon('check') + '已按合同冻结</span></div><div class="trade-contract-rule-summary"><div><span>合同金额</span><strong>¥' + item.amount.toFixed(2) + '</strong></div>' + (selfOperated ? '' : '<div><span>平台服务费</span><strong>' + formatServiceFeeRule(item) + '</strong><small>来自服务费规则，签订时快照</small></div>') + '<div><span>资金处理方式</span><strong>' + (selfOperated ? '运营方统一收款' : '按每一期实付金额自动分账') + '</strong><small>' + (selfOperated ? '不发起对外分账' : '平台保留服务费后分账给供方') + '</small></div></div><div class="trade-contract-stage-scroll"><table><thead>' + stageHead + '</thead><tbody>' + stageRows + '</tbody><tfoot>' + stageFoot + '</tfoot></table></div></section>'
    ...
    function render() {
        ...
        panel.innerHTML = ''
            ...
            +   '<section class="trade-contract-table-card"><div class="trade-contract-table-meta"><span>共 <strong>' + list.length + '</strong> 份合同</span><span>付款计划与服务费计费规则以合同快照为准</span></div><div class="trade-contract-table-scroll"><table><thead><tr><th>合同编号 / 名称</th><th>关联订单</th><th>交易标的</th><th>交易对方</th><th>合同金额</th><th>付款方式</th><th>状态</th><th>更新时间</th><th>操作</th></tr></thead><tbody>'
            +   list.map(function (item) {
                    ...
                    return '<tr><td><strong>' + item.name + '</strong><small>' + item.id + '</small></td><td><code>' + item.orderNo + '</code></td><td>' + item.itemName + '</td><td>' + counterparty + '</td><td><strong class="trade-contract-money">¥' + item.amount.toFixed(2) + '</strong><small>服务费 ' + formatServiceFeeRule(item) + '</small></td><td><strong>' + paymentLabel + '</strong><small>' + item.stages.map(function (stage) { return stage.percent + '%'; }).join(' / ') + '</small></td><td>' + statusTag(status) + '</td><td>' + item.updatedAt + '</td><td><div class="trade-contract-actions">' + (status.indexOf('待') === 0 ? button('签署', 'text', 'sign', 'sign', 'data-contract-id="' + item.id + '"') : '') + button('详情', 'text', 'detail', 'eye', 'data-contract-id="' + item.id + '"') + '</div></td></tr>';
                }).join('')
